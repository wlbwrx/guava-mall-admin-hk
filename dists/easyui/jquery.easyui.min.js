    ...
    function _f0(_f1) {
        ...
        _f4.find("div.tree-node").draggable({
            ...
            proxy: function (_f5) {
                ...
                p.html("<span class=\"tree-dnd-icon tree-dnd-no\"> </span>" + $(_f5).find(
                    ".tree-title").html());
                p.hide();
                return p;
            },
        ...
        update: function (jq, _1bb) {
            return jq.each(function () {
                _12d(this, $.extend({}, _1bb, {
                    checkState: _1bb.checked ? "checked" : (_1bb.checked === false ?
                        "unchecked" : undefined)
                }));
            });
        },
        ...
        render: function (_1c5, ul, data) {
            ...
            function _1cb(_1cc, _1cd) {
                ...
                for (var i = 0; i < _1cd.length; i++) {
                    ...
                    cc.push("<li>");
                    cc.push("<div id=\"" + item.domId + "\" class=\"tree-node" + (item.nodeCls ? " " + item
                        .nodeCls : "") + "\">");
                    ...
                    if (item.state == "closed") {
                        ...
                        if (item.children && item.children.length) {
                            ...
                            cc.push("<span class=\"tree-icon tree-folder tree-folder-open " + (item.iconCls ?
                                item.iconCls : "") + "\"></span>");
                        } else {
                            cc.push("<span class=\"tree-indent\"></span>");
